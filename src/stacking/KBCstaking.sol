...
// File: contracts/KBCSTACKING.sol

contract KBCSTACKING is Ownable, ReentrancyGuard {
    ...
    function userstacked() external view returns (uint256) {
...
contract SmartChefFactory is Ownable {
        ...
        onlyOwner
    {
        ...
        bytes memory bytecode = type(KBCSTACKING).creationCode;
        ...
        KBCSTACKING(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        deployedPools.push(
            PoolInfo({
                ...
                stakedToken: address(_stakedToken),
    ...
    function getDeployedPools() external view returns (PoolInfo[] memory) {
